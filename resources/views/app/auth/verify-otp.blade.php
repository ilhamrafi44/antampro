...
<head>
    <meta charset="utf-8">
    <title>Verifikasi OTP - Antam Pro</title>
    ...
    <style>
        ...
        .submit-btn {
            ...
            cursor: pointer;
            margin-top: 20px;
            margin-bottom: 20px; /* Menambahkan margin bawah untuk memberikan space */
        }
    ...
    <div class="form-container">
        ...
        <form action="{{ route('verify-otp') }}" method="post">
            ...
            <div class="form-item">
                ...
                <input type="number" id="otp" name="otp" placeholder="Masukkan kode OTP" autocomplete="off">
            </div>
