...
<div style="display: flex;justify-content: space-between;align-items: center;background: #1fc745;padding-bottom: 11px;">
    <div>
 ...
 <div class="topname" style="line-height: 50px; font-weight: bold; color: #fff;">
        <font style="vertical-align: inherit;">Ubah password</font>
    </div>    
</div>
                                        ...
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                ...
                                                <input type="password" id="oldpassword" maxlength="20"
                                                       ...
                                                       placeholder="Password lama" class="layui-input"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                ...
                                                <input type="password" id="password1" maxlength="20"
                                                       name="new_password"
                                                       placeholder="Password baru" class="layui-input"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
                                            <div class="inputdiv">
                                                ...
                                                <input type="password" id="password2" maxlength="20"
                                                       ...
                                                       placeholder="Konfirmasi password" class="layui-input"
                                                       autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="layui-form-item" style="height:48px;">
                                            <font style="vertical-align: inherit;"><font
                                                    style="vertical-align: inherit;"><input class="layui-btn"
                                                                                            id="confirm"
                                                                                            value="Ubah"
                                                                                            style="width: 100%; border: 0px; color: #fff; background: #36c726; height: 45px; line-height: 45px; border-radius: 25px; "
