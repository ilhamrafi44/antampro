...
<div style="width: 100%; margin: 0 auto; background: #1fc745; border-bottom: 0px solid #117546; " class="top">
...
<div style=" max-width:450px; margin:0 auto;margin-top: 70px;">
    ...
    border-radius: 7px;">
                <div>
                    <h3 style="font-weight: bold">Penarikan</h3>
                    <p>{{$element->created_at}}</p>
                </div>
                <div>
                    <h3 style="font-weight: bold">Rp {{number_format($element->amount)}}</h3>
                    <p class="sposp" style="text-transform: capitalize;">
...
@if(\App\Models\Withdrawal::where('user_id', auth()->id())->orderByDesc('id')->count() < 1 )
