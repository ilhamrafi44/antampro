...
<div style="width: 100%; margin: 0 auto; background: #4CAF50; border-bottom: 0px solid #117546; " class="top">
    <div style="float:left; text-align:left; line-height:46px;width:50%;" id="btnClose" onclick="window.location.href='{{route('user.team')}}'">
...
<div style=" max-width:450px; margin:0 auto;margin-top: 70px;">
    ...
    border-radius: 7px;">
                    <div>
                        <h3 style="font-weight: bold">Nomor HP</h3>
                        <p>{{$element->phone}}</p>
                    </div>
                    <div>
                        <h3 style="font-weight: bold">Berinvestasi</h3>
                        <p>{!! check_invested($element->id) !!}</p>
                    </div>
                    <div>
                        <h3 style="font-weight: bold">Total investasi</h3>
                        <p >
                            Rp {{total_investment($element->id)}}
                        </p>
                    </div>
                </li>
            @endforeach
