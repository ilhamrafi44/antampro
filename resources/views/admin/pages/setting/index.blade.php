                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control is-valid"
                                               name="maximum_deposit" id="maximum_deposit"
                                               placeholder="maximum_deposit"
                                               value="{{$data ? $data->maximum_deposit : old('maximum_deposit')}}">
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            Note: This is filed is optional
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="nicepay">Nicepay Active</label>
                                        <input type="text" class="form-control is-valid"
                                               name="nicepay" id="nicepay"
                                               placeholder="Nicepay Active"
                                               value="{{$data ? $data->nicepay : old('nicepay')}}">
                                        <div class="valid-feedback">
                                            <i class="bx bx-radio-circle"></i>
                                            Note: 1 is active 0 is inactive
                                        </div>
                                    </div>
