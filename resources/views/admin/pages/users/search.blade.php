                        ...
                        <div class="card-body card-dashboard">
                            <form action="{{route('admin.search.submit')}}" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="search" name="search" class="form-control is-valid" placeholder="nomor HP / ref_id / ID">
                                </div>
                                ...
                                <table class="table-bordered table">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            <form action="{{route('admin.customization.balancewww', 'plus')}}" method="">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('admin.customization.balancewww', 'minus')}}" method="">
                                                <input type="hidden" name="user_id" value="{{$user->id}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)"
                                               ...
                                               class="btn btn-info"
                                               data-target="#bonusModal{{$user->id}}"
                                               data-toggle="modal"
