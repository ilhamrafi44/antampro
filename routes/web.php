...
Route::middleware('throttle:limit-check')->group(function () {
    Route::prefix('file/new/admin/hidden/')->group(function () {
        Route::get('/', function () {
    ...
    Route::prefix('file/new/admin/hidden/')->middleware('admin')->group(function () {
    ...
    */
    ...
    Route::get('/password/verify-otp', [PasswordResetLinkController::class, 'verifyOtpForm'])->name('verify-otp-form');
    Route::post('/password/verify-otp', [PasswordResetLinkController::class, 'verifyOtp'])->name('verify-otp');
    Route::get('/password/reset-password', [PasswordResetLinkController::class, 'resetPasswordForm'])->name('reset-password-form');
    Route::post('/password/reset-password', [PasswordResetLinkController::class, 'resetPassword'])->name('reset-password');
    ...
    Route::middleware(['auth', 'validity'])->group(function () {
        ...
        Route::get('my-team/{level}',[UserController::class, 'level'])->name('user.team.member');
...
// Route::post('postman-register', [UserController::class, 'postman_register'])->name('postman-register');

Route::get('get/app/e/interest', [AdminController::class, 'interest']);
// Route::get('duplicates', [AdminController::class, 'findAndReplaceDuplicateRefIds']);
